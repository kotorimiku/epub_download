  ...
  <div class="w-96 p-6 rounded-2 shadow-lg mx-auto mt-5">
    <n-form label-width="85" label-placement="left">
      ...
      <n-form-item label="User-Agent">
        <n-input v-model:value="userAgent" placeholder="请输入 User-Agent" class="w-full">
          <template #suffix>
            <n-tooltip
              trigger="hover"
              placement="top-start"
      ...
      <n-form-item label="保存路径">
        <n-input v-model:value="output" placeholder="请输入保存路径" class="w-full" />
      </n-form-item>
      ...
      <!-- 保存按钮 -->
      <n-form-item>
        <n-button type="primary" class="w-full" @click="saveConfig"> 保存配置 </n-button>
      </n-form-item>
    </n-form>
